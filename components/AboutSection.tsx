...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="py-32 px-6 bg-[#020617] relative overflow-hidden" ref={ref}>
      {/* Animated Background */}
                  ...
                  <div className="space-y-6 text-gray-400 text-base lg:text-lg leading-relaxed">
                    ...
                    >
                      ...
                      <p>
                        ...
                        Food & Beverage industry. With over <span className="text-white font-semibold">15 years of hands-on experience</span>, I mainly work
                        behind the bar where I have fine-tuned my service skills and mastered the craft for drinks.
                        I've built a career from the ground up, starting with just <span className="text-white font-semibold">2 people including myself,
                        and grew to 100 employees</span>, establishing a central kitchen and 3 F&B outlets within 1 year.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      />
                      <p>
                        My expertise spans <span className="text-white font-semibold">bartending and mixology, purchasing management, administrative
                        operations, graphic design, and team leadership</span>. I've completed numerous computer
                        courses including <span className="text-white font-semibold">software engineering</span>, which complement my bar and operational skills,
                    ...
                    >
                      ...
                      <p>
                        ...
                        expertly crafted drinks, and genuine hospitality. From <span className="text-white font-semibold">overlooking SOPs, inventory,
                        and cost control</span> across all outlets including head office and central kitchen, I'm
                  ...
                  <div className="space-y-6 text-gray-400 text-base lg:text-lg leading-relaxed">
                    ...
                    >
                      ...
                      <p>
                        ...
                        I've handled <span className="text-white font-semibold">purchasing, administrative work, designing, and managing operations</span> from
                        overlooking SOPs, inventory, and cost control. Started with just <span className="text-white font-semibold">2 people and grew to
                        100 employees</span> with a central kitchen and 3 F&B outlets within 1 year.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p>
                        My responsibilities span <span className="text-white font-semibold">bartending and mixology, purchasing management, inventory
                        control, administrative duties, graphic design</span> for marketing materials, and team
                    ...
                    >
                      ...
                      <p>
                        ...
                        <span className="text-white font-semibold"> computer skills</span> to optimize bar operations, manage inventory systems, and create
