...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-20 px-6 bg-[#0a0a0a]" ref={ref}>
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="space-y-3">
                        {exp.positions.map((position, posIndex) => (
                          <div key={posIndex} className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-l-2 border-purple-500 pl-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {awards.map((award, index) => (
                <motion.div
                  ...
                  className="p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
                >
