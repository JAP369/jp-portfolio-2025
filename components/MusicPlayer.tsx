...
export default function MusicPlayer() {
  ...
  // Lofi/chill background music URL (you can replace with your own)
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              {/* Title */}
              <div className="mb-6">
                <h3 className="text-lg font-bold text-white mb-1">Background Music</h3>
                <p className="text-sm text-gray-400">Lofi Chill Beats</p>
              </div>
