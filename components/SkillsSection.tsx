...
const skills = [
  {
    ...
    description:
      "15+ years behind the bar, fine-tuning service and craft for drinks, specializing in cocktails and beverage preparation.",
    icon: (
      <svg
        viewBox='0 0 24 24'
        fill='none'
      ...
      >
        <path
          d='M6 3h12M8 3v6a4 4 0 0 0 4 4 4 4 0 0 0 4-4V3M12 13v8M8 21h8'
          strokeWidth='2'
          strokeLinecap='round'
  ...
  },
  {
    ...
    description:
      "Expert in beverage purchasing, vendor management, inventory control systems, and cost optimization.",
    icon: (
      <svg
        viewBox='0 0 24 24'
        fill='none'
  ...
  },
  {
    ...
    description:
      "Creating drink menus, marketing materials, and brand visuals with Adobe Creative Suite and digital tools.",
    icon: (
      <svg
        viewBox='0 0 24 24'
        fill='none'
  ...
  },
  {
    ...
    description:
      "Managing bar operations, staff leadership, administrative tasks, and business operations with computer proficiency.",
    icon: (
      <svg
        viewBox='0 0 24 24'
        fill='none'
  ...
  return (
    ...
    >
      ...
      <motion.div className='absolute inset-0 opacity-20' style={{ y }}>
        ...
        <div
          className='absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-gradient-to-br from-purple-500 to-pink-600 rounded-full filter blur-3xl animate-pulse'
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={`w-full h-full rounded-full bg-gradient-to-r ${skill.gradient} blur-md`}
                    />
                  </motion.div>
