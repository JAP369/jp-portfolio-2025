    ...
    >
      ...
      <motion.div
        ...
        animate={{
          opacity: hovered ? 1 : 0,
          boxShadow: hovered
            ? `0 0 28px 6px ${cocktail.accent}55`
            : "none",
        }}
      ...
      <motion.div
        ...
        animate={{
          ...
          borderColor: hovered ? `${cocktail.accent}60` : "rgba(255,255,255,0.1)",
        }}
...
export default function CocktailShowcaseSection() {
  ...
  return (
    ...
    >
      ...
      <FloatingOrb color="#7c3aed" style={{ width: 600, height: 600, top: "5%", left: "-10%", animationDelay: "0" }} />
      <FloatingOrb color="#0891b2" style={{ width: 500, height: 500, bottom: "5%", right: "-8%", animationDelay: "2" }} />
      <FloatingOrb color="#be185d" style={{ width: 350, height: 350, top: "40%", left: "40%", animationDelay: "4" }} />
