...
const WHATSAPP_NUMBER = "85297602612";
const WHATSAPP_MESSAGE = encodeURIComponent(
  "Hi Jonathan! I visited your portfolio and I'd love to discuss a project with you.",
);
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className='bg-white text-gray-900 text-sm font-medium px-4 py-2 rounded-2xl shadow-xl whitespace-nowrap'
          >
